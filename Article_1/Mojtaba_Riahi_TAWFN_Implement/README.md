...
create maps:
python make_contact_maps.py --manifest data/mini_real/manifest_human.csv --out data/mini_real/manifest_human_with_maps.csv

train:
python tawfn_repro.py --manifest data/mini_real/manifest_with_maps.csv --device cpu --outdir outputs_with_maps
